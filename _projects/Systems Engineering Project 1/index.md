...
description:  To design and create a physical environment,  a built environment or an
arena, where a 4-wheeled mobile robot,  LIMO robot from AgileX Robotics, is able to
perform certain functions,  localisation, mapping, path planning, navigation 
